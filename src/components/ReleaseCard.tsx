    ...
    >
      ...
      <div className="flex-1 min-w-0 flex flex-col justify-between py-1">
        <div>
          ...
          {(release.spotify_url || release.youtube_url || release.bandcamp_url) && (
            <div className="flex items-center justify-start sm:justify-end gap-2 mt-2">
              ...
              {release.youtube_url && (
                <span
                  ...
                  className="inline-flex items-center gap-1 px-2 py-0.5 text-xs font-medium bg-[#FF0000] text-white rounded hover:bg-[#cc0000] transition-colors cursor-pointer"
                >
                  <svg className="w-3 h-3" viewBox="0 0 24 24" fill="currentColor">
              ...
              {release.bandcamp_url && (
                <span
                  ...
                  className="inline-flex items-center gap-1 px-2 py-0.5 text-xs font-medium bg-[#1DA0C3] text-white rounded hover:bg-[#178da8] transition-colors cursor-pointer"
                >
                  <svg className="w-3 h-3" viewBox="0 0 24 24" fill="currentColor">
