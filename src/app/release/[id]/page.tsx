            ...
            <div className="flex flex-wrap items-center gap-2 mt-4">
              {release.spotify_url && (
                <a
                  ...
                  className="inline-flex items-center gap-1 px-2 py-0.5 text-xs font-medium bg-[#14532d] text-[#4ade80] rounded hover:bg-[#166534] transition-colors"
                >
              ...
              {release.youtube_url && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 px-2 py-0.5 text-xs font-medium bg-[#7f1d1d] text-[#fca5a5] rounded hover:bg-[#991b1b] transition-colors"
                >
                  <svg className="w-3 h-3" viewBox="0 0 24 24" fill="currentColor">
              ...
              {release.deezer_url && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 px-2 py-0.5 text-xs font-medium bg-gradient-to-r from-[#7c2d12] to-[#831843] text-[#fdba74] rounded hover:from-[#9a3412] hover:to-[#9d174d] transition-colors"
                >
                  <svg className="w-3 h-3" viewBox="0 0 24 24" fill="currentColor">
